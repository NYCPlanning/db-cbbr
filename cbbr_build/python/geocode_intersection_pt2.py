...
# read in cbbr table
cbbr = pd.read_sql_query('SELECT * FROM cbbr_submissions WHERE streetsegment IS NULL AND streetcross1 IS NOT NULL AND streetcross2 IS NOT NULL AND geom IS NULL;', engine)
