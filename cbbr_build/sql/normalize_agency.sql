...
SET agency = (CASE 
		WHEN agency_acronym = 'ACS' THEN upper('Administration for Children''s Services')
		WHEN agency_acronym = 'BPL' THEN upper('Brooklyn Public Library')
		WHEN agency_acronym = 'CEOM' THEN upper('Citywide Event Coordination and Management')
		WHEN agency_acronym = 'DCA' THEN upper('Department of Consumer Affairs')
		...
		WHEN agency_acronym = 'DOITT' THEN upper('Dept of Information Technology & Telecommunications')
		...
		WHEN agency_acronym = 'DYCD' THEN upper('Department of Youth & Community Development')
		WHEN agency_acronym = 'EDC' THEN upper('Economic Development Corporation')
		WHEN agency_acronym = 'FDNY' THEN upper('Fire Department')
		WHEN agency_acronym = 'HHC' THEN upper('Health and Hospitals Corporation')
		WHEN agency_acronym = 'HPD' THEN upper('Department of Housing Preservation & Development')
		...
		WHEN agency_acronym = 'MOCJ' THEN upper ('Mayor''s Office of Criminal Justice')
		WHEN agency_acronym = 'MOME' THEN upper('Mayor''s Office of Media and Entertainment')
		WHEN agency_acronym = 'NYCHA' THEN upper('Housing Authority')
		WHEN agency_acronym = 'NYCTA' THEN upper('Transit Authority')
		WHEN agency_acronym = 'NYPD' THEN upper('Police Department')
		WHEN agency_acronym = 'NYPL' THEN upper('New York Public Library')
		WHEN agency_acronym = 'OEM' THEN upper('Office of Emergency Management')
		WHEN agency_acronym = 'OMB' THEN upper('Mayor''s Office of Management and Budget')
		WHEN agency_acronym = 'QPL' THEN upper('Queens Borough Public Library')
